    ...
    for step in STEP:
        for mode in MODE:
            ...
            for p_id in P_IDS:
                ...
                part_in = 'C:/Users/BIAPT/Desktop'+"/step{}/{}PLI_{}_step{}_MDFA03.mat".format(step, mode[0], frequency, step)
                part_channels = 'C:/Users/BIAPT/Desktop'+"/step{}/{}PLI_{}_step{}_MDFA03_channels.mat".format(step, mode[0], frequency, step)
